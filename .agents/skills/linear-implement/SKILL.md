...
Add artifact classification service

- Extract classification logic from controller
...
3. Creates branch `dg/tra-142-artifact-classification-service`
4. Analyzes requirements and creates plan
5. Saves plan to memory graph
6. Presents plan: "This will create a new service object for artifact classification using the Result pattern..."
...
10. Reviews identify: "Extract classification logic to service object, apply Result pattern"
