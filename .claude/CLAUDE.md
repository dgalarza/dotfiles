...
- Blog cadence: 2 posts/month, publish Monday/Tuesday, newsletter Wednesday
- YouTube: weekly long-form
- Distribution: Rule of Five — every piece gets 5 distribution touches before the next one ships
- Full cadence details: check the project's `docs/content-cadence.md` when working in the website repo
